 ...
 */
declare type RouterLocationRequiredOnly = 'path' | 'url'

/**
 * Router 跳转参数混合类型
 */
declare type RouterLocationMixtureRaw<T, K extends keyof T = keyof T> =
 ...
 * Router 跳转参数
 */
declare type RouterLocationRaw =
string
 ...
 * Router Query 参数
 */
declare type LocationQueryRaw = Record<string, string | number | undefined | null>
 ...
 */
declare interface LocationUniAppParams
