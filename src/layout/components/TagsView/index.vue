...
import { type ITagView, useTagsViewStore } from '@/store'
...
function isActive(tag: ITagView) {
...
<template>
  <div class="tags-view-container">
    <ScrollPane class="tags-view-wrapper" :tag-refs="tagRefs">
      ...
      >
        {{ tag.meta?.title }}
        <el-icon v-if="!isAffix(tag)" :size="12" class="i-ep-circle-close" @click.prevent.stop="closeSelectedTag(tag)" />
      </RouterLink>
    </ScrollPane>
